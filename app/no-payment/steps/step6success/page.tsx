...
export default function Step6SuccessNoPayment() {
  const { t, i18n } = useTranslation();

  useEffect(() => {
    document.cookie = "eta_flow=; Path=/; Max-Age=0; SameSite=Lax";
  }, []);
      ...
      <div className="flex items-center justify-center px-4 pt-32">
        <div className="max-w-xl p-6 bg-white rounded-xl shadow-md border border-green-300 text-center">
          ...
          <p className="text-gray-800 text-lg">
            Su formulario fue enviado con éxito. Sus datos están siendo analizados y en breve
